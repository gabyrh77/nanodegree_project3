...
public class FootballAPIService {
 ...
 /*   private class HttpImageRequestTask extends AsyncTask<Void, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Void... params) {
            try {
                URL url = new URL("http://upload.wikimedia.org/wikipedia/commons/e/e8/Svg_example3.svg");
                ...
                Picture picture = svg.renderToPicture(50,50);
        ...
        protected void onPostExecute(Bitmap result) {
            // Update the view
            Log.e(LOG_TAG, "Bitmap: " + String.valueOf(result.getByteCount()));
        }
    }*/
